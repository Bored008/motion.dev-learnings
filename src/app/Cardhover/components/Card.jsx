    ...
    <>
      <AnimatePresence>
        {open && (
          ...
          className={cn('w-72 min-h-[26rem] h-[29rem] bg-white rounded-xl text-black font-sans  p-6 flex flex-col',
            ...
            <div className='flex items-center justify-center'>
              <button onClick={() => setOpen(false)} className='flex items-center justify-center gap-1 text-[12px] rounded-md px-2 py-1 mt-4
                 shadow-[0_1px_1px_rgba(0,0,0,0.05),0_4px_6px_rgba(34,42,53,0.04),0_24px_68px_rgba(47,48,55,0.05),0_2px_3px_rgba(0,0,0,0.04)]'>
                Bored
